...
// и туда записать случайное целое число от 0 до 20.
// При этом должен быть сформирован новый массив.

// 2. Отфильтровать и вывести в консоль всех игроков, 
// у которых рост выше или равен 180 и вес ниже 80.
...
let players = [
    ...
    const addGoalsFunction = (human) => {
      ...
      const players2 = players.map(addGoalsFunction);
